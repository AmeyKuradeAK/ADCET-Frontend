...
const WhiteboardDocumentation = () => {
  return (
    <div
      ...
      style={{
        background: "radial-gradient(circle at 50% 50%, rgba(0, 150, 255, 0.2), rgba(0, 0, 0, 0.8))",
        cursor: "url('/path/to/custom-cursor.svg'), auto", // Optional: For custom cursor (replace with actual path)
      }}
    >
      <div className="max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-xl p-8 text-white">
        <h1 className="text-4xl font-extrabold text-blue-700 mb-8 text-center cursor-pointer">
          Whiteboard Application Documentation
        </h1>

        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-4 text-gray-300 border-b pb-2">
            Overview
          </h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gray-700 cursor-pointer">
              ...
              <div className="mt-4">
                ...
                <div className="bg-gray-500 h-32 rounded-md animate-pulse"></div>
              </div>
            </div>
        ...
        <section className="mb-12">
          ...
          <ol className="list-decimal list-inside text-lg text-gray-400 space-y-4">
